...
--
-- Host: us-cdbr-iron-east-03.cleardb.net    Database: heroku_8817d68b4a21fb3
-- ------------------------------------------------------
...
CREATE TABLE `likes` (
  ...
  `dateupdated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`likeid`)
) ENGINE=InnoDB AUTO_INCREMENT=852 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-04-27  0:05:13
